...
router.put('/me', protect, validate(authValidation.profile), authController.updateProfile);
...
router.put('/reset-password/:token', authLimiter, validate(authValidation.resetPassword), authController.resetPassword);
